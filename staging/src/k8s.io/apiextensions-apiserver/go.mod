...
replace golang.org/x/exp => golang.org/x/exp v0.0.0-20210220032938-85be41e4509f
...
replace github.com/Microsoft/go-winio => github.com/Microsoft/go-winio v0.4.15
...
replace github.com/aws/aws-sdk-go => github.com/aws/aws-sdk-go v1.35.24

replace github.com/blang/semver => github.com/blang/semver v3.5.1+incompatible
...
replace github.com/container-storage-interface/spec => github.com/container-storage-interface/spec v1.3.0

replace github.com/containernetworking/cni => github.com/containernetworking/cni v0.8.0

replace github.com/coredns/corefile-migration => github.com/coredns/corefile-migration v1.0.11
...
replace github.com/golang/groupcache => github.com/golang/groupcache v0.0.0-20200121045136-8c9f03a8e57e

replace github.com/golang/mock => github.com/golang/mock v1.4.4

replace github.com/google/cadvisor => github.com/google/cadvisor v0.38.8

replace github.com/google/go-cmp => github.com/google/go-cmp v0.5.2

replace github.com/google/gofuzz => github.com/google/gofuzz v1.1.0

replace github.com/google/uuid => github.com/google/uuid v1.1.2

replace github.com/googleapis/gnostic => github.com/googleapis/gnostic v0.4.1

replace github.com/hashicorp/golang-lru => github.com/hashicorp/golang-lru v0.5.1

replace github.com/heketi/heketi => github.com/heketi/heketi v10.2.0+incompatible
...
replace github.com/miekg/dns => github.com/miekg/dns v1.1.35
...
replace github.com/opencontainers/selinux => github.com/opencontainers/selinux v1.6.0
...
replace github.com/quobyte/api => github.com/quobyte/api v0.1.8
...
replace github.com/storageos/go-api => github.com/storageos/go-api v2.2.0+incompatible
...
replace golang.org/x/crypto => golang.org/x/crypto v0.0.0-20210220033148-5ea612d1eb83

replace golang.org/x/net => golang.org/x/net v0.0.0-20210224082022-3d97a244fca7

replace golang.org/x/oauth2 => golang.org/x/oauth2 v0.0.0-20200107190931-bf48bf16ab8d

replace golang.org/x/sys => golang.org/x/sys v0.0.0-20210225134936-a50acf3fe073

replace golang.org/x/term => golang.org/x/term v0.0.0-20210220032956-6a3ed077a48d

replace golang.org/x/time => golang.org/x/time v0.0.0-20210220033141-f8bda1e9f3ba
...
replace dmitri.shuralyov.com/gpu/mtl => dmitri.shuralyov.com/gpu/mtl v0.0.0-20201218220906-28db891af037
...
replace github.com/armon/go-radix => github.com/armon/go-radix v0.0.0-20180808171621-7fddfc383310
...
replace github.com/bketelsen/crypt => github.com/bketelsen/crypt v0.0.3-0.20200106085610-5cbc8cc4026c
...
replace github.com/checkpoint-restore/go-criu/v4 => github.com/checkpoint-restore/go-criu/v4 v4.1.0
...
replace github.com/containerd/containerd => github.com/containerd/containerd v1.4.1
...
replace github.com/containerd/ttrpc => github.com/containerd/ttrpc v1.0.2

replace github.com/containerd/typeurl => github.com/containerd/typeurl v1.0.1
...
replace github.com/form3tech-oss/jwt-go => github.com/form3tech-oss/jwt-go v3.2.2+incompatible

replace github.com/fvbommel/sortorder => github.com/fvbommel/sortorder v1.0.1
...
replace github.com/go-gl/glfw/v3.3/glfw => github.com/go-gl/glfw/v3.3/glfw v0.0.0-20200222043503-6f7a984d4dc4
...
replace github.com/google/pprof => github.com/google/pprof v0.0.0-20200229191704-1ebb73c60ed3
...
replace github.com/hashicorp/consul/api => github.com/hashicorp/consul/api v1.1.0

replace github.com/hashicorp/consul/sdk => github.com/hashicorp/consul/sdk v0.1.1

replace github.com/hashicorp/errwrap => github.com/hashicorp/errwrap v1.0.0

replace github.com/hashicorp/go-cleanhttp => github.com/hashicorp/go-cleanhttp v0.5.1

replace github.com/hashicorp/go-immutable-radix => github.com/hashicorp/go-immutable-radix v1.0.0
...
replace github.com/hashicorp/go-rootcerts => github.com/hashicorp/go-rootcerts v1.0.0
...
replace github.com/hashicorp/go.net => github.com/hashicorp/go.net v0.0.1

replace github.com/hashicorp/hcl => github.com/hashicorp/hcl v1.0.0

replace github.com/hashicorp/logutils => github.com/hashicorp/logutils v1.0.0

replace github.com/hashicorp/mdns => github.com/hashicorp/mdns v1.0.0

replace github.com/hashicorp/memberlist => github.com/hashicorp/memberlist v0.1.3

replace github.com/hashicorp/serf => github.com/hashicorp/serf v0.8.2
...
replace github.com/jmespath/go-jmespath => github.com/jmespath/go-jmespath v0.4.0

replace github.com/jmespath/go-jmespath/internal/testify => github.com/jmespath/go-jmespath/internal/testify v1.5.1
...
replace github.com/karrick/godirwalk => github.com/karrick/godirwalk v1.16.1
...
replace github.com/mitchellh/cli => github.com/mitchellh/cli v1.0.0
...
replace github.com/mitchellh/gox => github.com/mitchellh/gox v0.4.0

replace github.com/mitchellh/iochan => github.com/mitchellh/iochan v1.0.0
...
replace github.com/opencontainers/runtime-spec => github.com/opencontainers/runtime-spec v1.0.3-0.20200728170252-4d89ac9fbff6

replace github.com/pascaldekloe/goe => github.com/pascaldekloe/goe v0.0.0-20180627143212-57f6aae5913c
...
replace github.com/posener/complete => github.com/posener/complete v1.1.1
...
replace github.com/prometheus/procfs => github.com/prometheus/procfs v0.2.0
...
replace github.com/ryanuber/columnize => github.com/ryanuber/columnize v0.0.0-20160712163229-9b3edd62028f

replace github.com/satori/go.uuid => github.com/satori/go.uuid v1.2.0

replace github.com/sean-/seed => github.com/sean-/seed v0.0.0-20170313163322-e2103e2c3529
...
replace github.com/subosito/gotenv => github.com/subosito/gotenv v1.2.0
...
replace github.com/vishvananda/netns => github.com/vishvananda/netns v0.0.0-20200728191858-db3c7e526aae

replace github.com/willf/bitset => github.com/willf/bitset v1.1.11-0.20200630133818-d5bec3311243
...
replace golang.org/x/lint => golang.org/x/lint v0.0.0-20200302205851-738671d3881b

replace golang.org/x/mobile => golang.org/x/mobile v0.0.0-20201217150744-e6ae53a27f4f

replace golang.org/x/mod => golang.org/x/mod v0.3.1-0.20200828183125-ce943fd02449
...
replace gopkg.in/ini.v1 => gopkg.in/ini.v1 v1.51.0
...
replace honnef.co/go/tools => honnef.co/go/tools v0.0.1-2020.1.3
...
replace sigs.k8s.io/structured-merge-diff/v4 => sigs.k8s.io/structured-merge-diff/v4 v4.0.3
